...
class GraphAnalysisTab(QWidget):
    ...
    def __init__(self):
        ...
        # right side widget
        self.graph_analysis_parameter_matplotlib_plot_pushbutton = QPushButton('Output via Matplotlib')
        self.graph_analysis_parameter_plotly_plot_pushbutton = QPushButton('Output via Plotly')

        self.graph_analysis_parameter_right_grid.\
            addWidget(self.graph_analysis_parameter_matplotlib_plot_pushbutton)
        self.graph_analysis_parameter_right_grid.\
            addWidget(self.graph_analysis_parameter_plotly_plot_pushbutton)

        # Modularize it
        self.graph_analysis_left_grid_addwidget()   # add left side to the larger grid layout
        self.graph_analysis_right_grid_addwidget()  # add right side to the larger grid layout
    ...
    def graph_analysis_left_grid_addwidget(self):
        ...
        self.graph_analysis_parameter_left_grid.\
            addWidget(self.graph_analysis_pmax_spinbox, 4, 1)
        self.graph_analysis_parameters_grid.\
            addLayout(self.graph_analysis_parameter_left_grid, 0, 0)

    def graph_analysis_right_grid_addwidget(self):
        self.graph_analysis_parameters_grid.\
            addLayout(self.graph_analysis_parameter_right_grid, 0, 1)
